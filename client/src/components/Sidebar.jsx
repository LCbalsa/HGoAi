...
const Sidebar = ({sidebar, setSidebar}) => {
  ...
  return (
    ...
    max-sm:absolute top-14 bottom-0 ${sidebar ? 'translate-x-0' : 'max-sm:-translate-x-full'} transition-all
    duration-300 ease-in-out`}>
        <div className='my-7 w-full'>
            <img src={user.imageUrl} alt='user-img' className='w-13 rounded-full mx-auto' />
